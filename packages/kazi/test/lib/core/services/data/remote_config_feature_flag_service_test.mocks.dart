...
// in kazi/test/lib/core/services/data/remote_config_feature_flag_service_test.dart.
...
/// A class which mocks [RemoteConfigValue].
///
/// See the documentation for Mockito's code generation for more information.
class MockRemoteConfigValue extends _i1.Mock implements _i3.RemoteConfigValue {
  MockRemoteConfigValue() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.ValueSource get source =>
      (super.noSuchMethod(
            Invocation.getter(#source),
            returnValue: _i3.ValueSource.valueStatic,
          )
          as _i3.ValueSource);
  ...
  @override
  int asInt() =>
      (super.noSuchMethod(Invocation.method(#asInt, []), returnValue: 0)
          as int);

  @override
  double asDouble() =>
      (super.noSuchMethod(Invocation.method(#asDouble, []), returnValue: 0.0)
          as double);

  @override
  bool asBool() =>
      (super.noSuchMethod(Invocation.method(#asBool, []), returnValue: false)
          as bool);
}
