...
// in kazi/test/lib/features/services/presenter/controllers/service_status_controller_test.dart.
...
class MockServicesRepository extends _i1.Mock
  ...
  @override
  _i5.Future<List<_i6.Service>> add(
    _i6.Service? service, [
    int? quantity = 1,
  ]) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<List<_i6.Service>> get(
    String? userId,
    DateTime? startDate, [
    DateTime? endDate,
  ]) =>
  ...
  @override
  _i5.Future<void> update(_i6.Service? service) =>
      (super.noSuchMethod(
...
class MockCatalogItemRepository extends _i1.Mock
    implements _i7.CatalogItemRepository {
