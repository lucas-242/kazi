...
class KaziColorRoles extends ThemeExtension<KaziColorRoles> {
  ...
  static const light = KaziColorRoles(
    accentInk: KaziColors.ambar,
    accentInkStrong: KaziColors.ambar700,
    accentSurface: KaziColors.kazi,
    accentSurfacePressed: KaziColors.amarelo600,
    onAccentSurface: KaziColors.grafite,
    accentSubtle: KaziColors.amarelo100,
    onAccentSubtle: KaziColors.grafite,
    focusRing: KaziColors.grafite,
    success: KaziColors.success,
    onSuccess: KaziColors.branco,
    ...
    onInfo: KaziColors.branco,
    infoContainer: KaziColors.infoContainerLight,
    onInfoContainer: KaziColors.onInfoContainerLight,
    moneySurface: KaziColors.grafite,
    onMoneySurface: KaziColors.nevoa,
    moneyAccent: KaziColors.kazi,
    categories: _categories,
  );

  /// The dark-mode roles.
  static const dark = KaziColorRoles(
    accentInk: KaziColors.kazi,
    accentInkStrong: KaziColors.kazi,
    accentSurface: KaziColors.kazi,
    accentSurfacePressed: KaziColors.amarelo600,
    onAccentSurface: KaziColors.grafite,
    accentSubtle: KaziColors.amarelo900,
    onAccentSubtle: KaziColors.kazi,
    focusRing: KaziColors.kazi,
    success: KaziColors.successDark,
    onSuccess: KaziColors.grafite,
